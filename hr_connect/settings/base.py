...
ALLOWED_HOSTS = [
    "hr-connect-prod.apigateway.in",
    "hr-connect-alpha.apigateway.in",
    "hr-connect-beta.apigateway.in",
    "hr-connect-gamma.apigateway.in",
    "hr-connect-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [hr_connect - " + os.environ.get("STAGE", "local") +
...
# ****************** App Source Config ******************
HR_CONNECT_SOURCE = "hr-connect-source"
