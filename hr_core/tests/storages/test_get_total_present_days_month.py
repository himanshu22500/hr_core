...
def test_get_total_present_days_month_with_no_clock_in_entry(create_employees):
    # Arrange
...
@pytest.mark.django_db
def test_get_total_present_days_month_with_one_clock_in_entry(create_clock_out_attendance):
    # Arrange
    sql_storage = StorageImplementation()
    employee_obj = Employee.objects.get(employee_id="1")
    attendance_param = AttendanceParamDTO(
