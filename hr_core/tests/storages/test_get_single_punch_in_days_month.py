...
class TestGetTotalSinglePunchInDays:
    @pytest.mark.django_db
    def test_with_no_clock_in_entry_returns_zero(self, create_employees):
        # Arrange
    ...
    @pytest.mark.django_db
    def test_with_one_single_punch_in_entry_returns_one(self, create_single_punch_in_attendance):
        # Arrange
        sql_storage = StorageImplementation()
        employee_obj = Employee.objects.get(employee_id="1")
        attendance_param = AttendanceParamDTO(
